...
*                                                                                                 *
***************************************************************************************************/
BOOL BMP::IsSupport(const BMP &img)
{
	return TRUE;
}

BOOL BMP::IsSupport(const IplImage &img)
{
	return TRUE;
}
...
IplImage * BMP::BMP2Ipl() 
{
	...
	{
		CopyData(iplImg->imageData, (char*)bmpData, bfHeader.bfSize - bfHeader.bfOffBits, isLowerLeft, height);
	}
	else
	{
